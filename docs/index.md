...
* 遅いです。大量計算には向きません ※1
* セルに表示出来る計算結果は、小数点文字含めて、32,767 文字までです ※2
...
これはExcelの仕様に、「セルが含むことができる合計文字数は32,767 文字まで」とある為です。  
...
返却値型をString型としているので、VBのString型の格納文字数制限('およそ'20億とMicrosoftはいっています)までしか取り扱えません。
